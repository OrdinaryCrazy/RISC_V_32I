...
HD_PWD='C:/Users/workspace/RISC_V_32I/RISC_V_32I/RISC_V_32I.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32Core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32Core.tcl
