...
HD_PWD='C:/Users/workspace/RISC_V_32I/Cache/Cache.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WBSegReg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WBSegReg.tcl
